...
function index()
local page = entry({"admin", "services", "AdGuardHome"},alias("admin", "services", "AdGuardHome", "adgstat"),_("AdGuard Home"))
page.order = 10
page.dependent = true

entry({"admin","services","AdGuardHome","base"},cbi("AdGuardHome/base"),_("Base Setting"),2).leaf = true
entry({"admin","services","AdGuardHome","log"},form("AdGuardHome/log"),_("Log"),4).leaf = true
entry({"admin","services", "AdGuardHome","adgstat"},template("AdGuardHome/adgstat"),_("Web"), 1).leaf = true
